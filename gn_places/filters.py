...
class GeoNamesPlaceListFilter(django_filters.FilterSet):
    ...
    gn_feature = django_filters.ModelMultipleChoiceFilter(
        queryset=SkosConcept.objects.filter(
            collection__name="gn_feature"
        ),
        help_text=GeoNamesPlace._meta.get_field('gn_feature').help_text,
        label=GeoNamesPlace._meta.get_field('gn_feature').verbose_name,
        widget=autocomplete.Select2Multiple(
            url="/vocabs-ac/specific-concept-ac/gn_feature",
            attrs={
                'data-placeholder': 'Autocomplete ...',
                'data-minimum-input-length': 2,
                },
